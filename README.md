...
当前项目在默认文档能力的基础上，做了更贴近个人主页的首页改造，包括：

- 个人主页首页风格化布局
- 基于 Markdown 文章元数据的专题归档
- 首页博客 / 关于我 双标签切换
- 本地全文搜索
- 同专题文章的上一篇 / 下一篇引导
- 支持通过 Markdown 持续扩展博客内容

## 贡献

如果你发现页面问题、文章链接异常、样式瑕疵，或者对博客结构和功能有建议，欢迎提交 Issue 或 Pull Request。

- GitHub Issues: https://github.com/Yanxiyimengya/YanxiyimengPersonalBlog/issues

## 作者主页

- GitHub: [Yanxiyimengya](https://github.com/Yanxiyimengya)
- Bilibili: [烟汐忆梦_YM](https://space.bilibili.com/481430814)
